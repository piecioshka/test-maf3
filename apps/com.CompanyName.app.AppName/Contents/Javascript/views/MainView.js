var MainView = new MAF.Class({
    ...
    dataHasChanged: function (event) {
        console.log('MainView#dataHasChanged');
    ...
    channelChange: function () {
        console.log('MainView#channelChange');
    ...
    animteBar: function (fadeIn, fadeOut, barHeight, barOffset) {
        console.log('MainView#animteBar');
        fadeOut.animate({
            opacity: 0,
            duration: 0.2,
            events: {
    ...
    onActivateBackButton: function (event) {
        console.log('MainView#onActivateBackButton');
        if (!this.frozen) {
    ...
    createView: function () {
        console.log('MainView#createView');
    ...
    focusView: function () {
        console.log('MainView#focusView');
    ...
    destroyView: function () {
        console.log('MainView#destroyView');
